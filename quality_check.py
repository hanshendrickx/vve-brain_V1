...
class QualityChecker:
    ...
    def check_ruff(self):
        ...
        if not success:
            print("\n💡 To auto-fix, run: uv run ruff check --fix src/ tests/")
        
        self.results["ruff"]["status"] = "✅" if success else "❌"
    ...
    def check_tests(self):
        ...
        self.results["tests"]["status"] = "✅" if success else "❌"
    ...
    def auto_fix(self):
        ...
        print("\n✅ Auto-fix complete!")
        print("💡 Now run quality_check.py again to verify")
